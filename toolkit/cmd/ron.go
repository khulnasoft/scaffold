...
import (
	...
	"github.com/khulnasoft/scaffold/toolkit/toolkit"
	"github.com/khulnasoft/scaffold/toolkit/toolkit/k8s"
)
...
var ronCmd = &cobra.Command{
	...
	Run: func(_ *cobra.Command, args []string) {
		...
		pvc := k8s.WithScaffoldLabel(k8s.NewUnstructuredPVC(
		...
		pod := k8s.WithScaffoldLabel(k8s.NewUnstructuredPod(
		...
		if len(RonOpts.ConfigMapMounts) > 0 {
			...
			cm = k8s.WithScaffoldLabel(k8s.NewUnstructuredConfigMap(
