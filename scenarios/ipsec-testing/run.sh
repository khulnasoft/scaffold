#!/usr/bin/env bash
# Run netperf against different versions of Khulnasoft.
# Assumes cluster has just been created an Khulnasoft is not
# installed yet.
set -xe
...
do
  ...
  do
    ...
    do
      ...
      ./install-khulnasoft.sh $tag $sha $enc $monitor
